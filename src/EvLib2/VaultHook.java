...
//				plugin.getLogger().info("Vault not found, using EssentialsEco as economy base");
	...
	public static double getBalance(OfflinePlayer p) throws com.earth2me.essentials.api.UserDoesNotExistException {
	...
	public static boolean hasAtLeast(OfflinePlayer p, double amount){
		if(VaultHook.vaultEnabled()){
			...
			catch(com.earth2me.essentials.api.UserDoesNotExistException e){return false;}
		}
	}
	...
	public static boolean giveMoney(OfflinePlayer p, double amount){
		...
		if(VaultHook.vaultEnabled()){
			...
			catch(com.earth2me.essentials.api.NoLoanPermittedException e){return false;}
			catch(com.earth2me.essentials.api.UserDoesNotExistException e){return false;}
			return true;
		}
	}
